...
export default function Pager(props) {
    ...
    return (<Box component="nav" aria-label="Search results pagination" sx={{
            margin: 'auto',
            display: 'flex',
            justifyContent: 'center',
            width: '100%'
        }}>
            <StyledPagination page={page} count={totalPages} variant="outlined" shape="rounded" onChange={(_, newPage) => handlePageChange(newPage)} showFirstButton showLastButton siblingCount={PAGE_WINDOW} boundaryCount={1}/>
        </Box>);
}
